...
@NgModule({
  declarations: [Step1Component, HeaderComponent, DashboardComponent, GragComponent, IconDashComponent, SplashDashComponent, DatabaseComponent, ForumComponent,ProfileClientComponent,DialogValidationComponent,
    ForumlistComponent,
